...
echo ""
echo "  # Repo local paths (set to YOUR local checkout locations)"
echo "  export PW_FRONTEND_PATH=\"/path/to/pw-react-client-v3\""
echo "  export PW_BACKEND_PATH=\"/path/to/pw-server-v3\""
echo "  export PW_AI_SERVER_PATH=\"/path/to/pw-ai-server\""
